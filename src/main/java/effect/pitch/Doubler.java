...
import effect.values.DoublerDelay;
import effect.values.DoublerPitch;
import effect.values.OffOn;
import effect.values.OutLev;
import effect.values.Side;

public class Doubler extends SubEffectTemplate {
	@Override
	...
	public ParameterTemplate[] getParameterTemplates() {
		return new ParameterTemplate[] { new ParameterTemplate("Delay", 36, new DoublerDelay()),
				new ParameterTemplate("Pitch", 12, new DoublerPitch()), new ParameterTemplate("Side", 84, new Side()),
