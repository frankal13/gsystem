 ...
 * 
 * Parameter »HiCut« Wertebereich: 20 Hz bis 20 kHz Mit diesem Parameter können
 * Sie den Anteil der höheren Frequenzen am Flangereffekt vermindern. Verwenden
 ...
 * steuert den Grad der Rückkopplung (Feedback) des kurzen modulierten Delays,
 * das für den typischen Flanger-Effekt verantwortlich ist. Ein zu hoher
 * Feedback-Wert (zwischen 90 % und 95 %) kann zu einem internen Feedback
 * führen, das als »jaulendes« Nebengeräusch hörbar wird und normalerweise nicht
 * erwünscht ist. Achten Sie auf diesen Nebeneffekt besonders dann, wenn Sie mit
 * hohen Pegeln arbeiten. Wenn Sie für diesen Parameter eine negative
 * Einstellung wählen, wird die Phase des Signalanteils, der an den Eingang
 * zurückgeführt wird, umgekehrt.
 * 
 * Parameter »FB Cut« (Feedback Highcut) Wertebereich: 20 Hz bis 20 kHz Mit
 * diesem Parameter können Sie die oberen Frequenzen der mit dem
 * »Feedback«-Parameter erzeugten Resonanzen abschwächen.
 * 
